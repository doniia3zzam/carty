            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <div id="supp_pro">
                            @include('supplier.supp_pro_page')
                        </div>
                    </div>
                    <script>
                        $(document).ready(function(){
                            ...
                            function fetch_data(page){
                                $.ajax({
                                    url:"{{url('allproducts_supp_page/'.Session::get('supplier')['supplier_id'].'?page=')}}"+page,
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="deleteForm{{$i}}" method="POST" action="{{url('supp_pro')}}">
                    @method('DELETE')
                    @csrf
