                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="all_cat_table">
                                    @include('all_categories.all_categories_pagination')
                                </div>
                            </div>
                            <script>
                                $(document).ready(function(){
                                    ...
                                    function fetch_data(page){
                                        $.ajax({
                                            url:"{{ url('categories/?page=')}}"+page,
                                            success:function(data)
                                            {
                                                $('#all_cat_table').html(data);
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-danger" id="smallmodalLabel">Delete Category</h5>
                        ...
                        <form action="category/2" method="POST">
                            ...
                            <div class="modal-footer">
                                <input type="hidden" name="category_id" id="inputModal{{$i}}">
