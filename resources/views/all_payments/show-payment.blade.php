                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="pay_table">
                                    @include('all_payments.pay_pagination')
                                </div>
                            </div>
                            <script>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-danger" id="smallmodalLabel">Delete Payment</h5>
                        ...
                        <div class="modal-body">
                            <p>
                                Are you sure, you want to delete this type of payment ?
                        ...
                        <form action="payment/2" method="POST">
                            ...
                            <div class="modal-footer">
                                <input type="hidden" name="payment_id" id="inputModal{{$i}}">
