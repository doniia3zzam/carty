                ...
                <div class="col-md-12">
                    <div class="card">
                            <div class="card-header">
                                <strong class="card-title">models</strong>
                            </div>
                        <div class="card-body">
                            <div id="models_table">
                                @include('all_models.allmodels_pagination')
                            </div>
                        </div>
                        <script>
                            $(document).ready(function(){
                                ...
                                function fetch_data(page){
                                    $.ajax({
                                        url:"{{ url('models/?page=')}}"+page,
                                        success:function(data)
                                        {
                                            $('#models_table').html(data);
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-danger" id="smallmodalLabel">Delete Model</h5>
                ...
                <form action="model/2" method="POST">
                    @method('delete')
                    {{ csrf_field() }}
                    <div class="modal-footer">
                        <input type="hidden" name="model_id" id="inputModal{{$i}}">
