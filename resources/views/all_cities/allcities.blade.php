            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">cities</strong>
                    </div>
                    <div class="card-body">
                        <div id="city_table">
                            @include('all_cities.allcities_pagination')
                        </div>
                    </div>
                    <script>
                        $(document).ready(function(){
                            ...
                            function fetch_data(page){
                                $.ajax({
                                    url:"{{ url('cities/?page=')}}"+page,
                                    success:function(data)
                                    {
                                        $('#city_table').html(data);
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-danger" id="smallmodalLabel">Delete City</h5>
                ...
                <form action="city/2" method="POST">
                    @method('delete')
                    {{ csrf_field() }}
                    <div class="modal-footer">
                        <input type="hidden" name="city_id" id="inputModal{{$i}}">
