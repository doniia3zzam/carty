                                        ...
                                        <a href="#miniCart" class="minicart-btn toolbar-btn">
                                            ...
                                            <?php
                                              if(isset($_COOKIE["cart"]))
                                              {
                                                  ...
                                                  <span class="item-count"><?php echo count($cart_data); ?></span>
                                                  <?php
                                              }
                    ...
                    <div class="row">
                        ...
                        <div class="custom-setting_col col-12 d-none d-lg-block">
                            <div class="ht-right_area">
                                <div class="ht-menu">
                                    <ul>
                                        <li><a href="myaccount.php"></span> <span> Hello
                                                </span> <span class="fa fa-user"> <i class="fa fa-chevron-down"></i></a>
                            ...
                            <div class="main-menu_area position-relative">
                                <nav class="main-nav">
                                    <ul>
                                        ...
                                        <li><a href="allproducts.php">Products</a></li>
                                        <li class=""><a href="allproducts.php">Categories</a></li>

                                        <li class=""><a href="about-us.php">About Us</a></li>
                                        <li class=""><a href="contact.php">Contact</a></li>
                                        <li class=""><a href="allproducts.php"><i class="fas fa-user"></i><i class="ion-ios-arrow-down"></i></a>
                                            <ul class="hm-dropdown">
                                                <li>
                                                    <ul class="hm-dropdown">
                                                        <li><a href="login.php">Login <i class="fas fa-sign-in-alt"></i></a></li>
                    ...
                    <div class="minicart-content">
                        ...
                        <ul class="minicart-list">
                            <?php
                                ...
                                {
                            ?>
                                <li class="minicart-product rem<?php echo($x)?>">
                                ...
                                <div class="product-item_content">
                                    <a class="product-item_title" href="shop-left-sidebar.php"><?php echo($values['product_name']) ?></a>
                                    <span class="product-item_quantity"><?php $q =$values['quantity']; echo($q .' X'); $p =$values['price']; echo($p.' EGP'); $s = $p * $q; $total+=$s?></span>
                                </div>
                                <input type="hidden"name="pro"value="<?php echo($values['product_id']);?>">
                                <input type="hidden"name="supp"value="<?php echo($values['supplier_id']);?>">
                                <button type="submit" name="remove"  class="product-item_remove"><i class="ion-android-close"></i></button>
                            </li><?php
                            if(isset($_POST['remove']))
                                {
                                    ...
                                    foreach($cart_data as $keys => $values)
                                    {
                                        if($cart_data[$keys]['product_id'] == $_POST['pro'] && $cart_data[$keys]['supplier_id'] == $_POST['supp'] )
                                        {
